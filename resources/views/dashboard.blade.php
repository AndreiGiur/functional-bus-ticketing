...
@section('title', isset($balance) ? 'Portofel' : 'Default Title')
    ...
    <div class="bg-gray-800 text-white py-4 px-8">
        <div class="flex items-center justify-between">
            <div class="text-lg">
                ...
                @else
                <p class="font-semibold" style="color: white;">User not authenticated. Please log in.</p>
                @endif
                <p class="text-sm" style="color: white;">Portofelul tau!</p>
            </div>
            <div class="text-center text-xl font-bold">
                <p style="color: white;">Balanta ta</p>
                <p>{{ isset($balance) ? number_format($balance, 2) : '0.00' }} RON</p>
            </div>
        </div>
    </div>
